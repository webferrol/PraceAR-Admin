    ...
    if (!$conn) {
        ...
        if (isset($_GET['id_nave'])) {
			...
			$sql = "SELECT 
                    ...
                    AND (p.caseta BETWEEN 'NC120' AND 'NC135'
                    OR p.caseta LIKE 'MC001')
            ...
            if ($resultado->num_rows > 0) {
                ...
                echo json_encode(["codigo" => 203, "mensaje" => "El puesto no existe en el sistema. No hay registros", "respuesta" => ""]);
            }
        } else {
